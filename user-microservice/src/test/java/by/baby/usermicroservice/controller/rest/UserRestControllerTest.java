...
public class UserRestControllerTest {
    ...
    public void shouldUpdateUserSuccessfully() {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/user/" + user1.getId())
                ...
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.id").value(user1.getId()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.username").value(updUser.getUsername()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.authToken").value(updUser.getAuthToken()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.money").value(updUser.getMoney()));
    }
